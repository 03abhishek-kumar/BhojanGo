...
const Checkout = () => {
  return (
    <div className="bg-[#F5F3EE] dark:bg-[#0A0A0A] min-h-screen transition-colors duration-300">
      ...
      {/* Footer */}
      <footer className="mt-12 border-t border-black/5 dark:border-[#222222] bg-white dark:bg-[#111111] px-[5%] py-6 flex items-center justify-between transition-colors duration-300">
