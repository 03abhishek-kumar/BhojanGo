  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-end items-start pt-20 pr-6">
      ...
      >
        ...
        {/* ── Notification list ── */}
        <div className="max-h-[380px] overflow-y-auto px-3 py-2 custom-scrollbar">
          {notifications.map((n) => {
            const Icon = n.icon;
            return (
              <div
              ...
              >
                {/* Icon */}
                <div
                  className={`w-10 h-10 rounded-xl bg-gradient-to-br ${n.iconBg} flex items-center justify-center shrink-0`}
                >
