      ...
      >
        ...
        <div className="px-3 py-2">
          {quickToggles.map(({ icon: Icon, label, desc }) => (
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center shrink-0 group-hover:from-orange-100 group-hover:to-orange-200 transition-all">
                <Icon className="w-[18px] h-[18px] text-[#F4521E]" />
              </div>
              ...
              {/* toggle pill */}
              <div className="w-10 h-[22px] rounded-full bg-slate-200 relative cursor-pointer shrink-0 transition-colors hover:bg-slate-300">
        ...
        <div className="px-3 py-2">
          {navLinks.map(({ icon: Icon, label, to }) => (
            <div
              ...
              className="flex items-center gap-3 px-2 py-2.5 rounded-xl hover:bg-orange-50/70 transition-all cursor-pointer group"
            >
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center shrink-0 group-hover:from-orange-50 group-hover:to-orange-100 transition-all">
                <Icon className="w-[18px] h-[18px] text-slate-600 group-hover:text-[#F4521E] transition-colors" />
              </div>
        ...
        <div className="px-3 pt-2 pb-3">
          <div className="flex items-center gap-3 px-2 py-2.5 rounded-xl hover:bg-red-50/70 transition-all cursor-pointer group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-red-50 to-red-100 flex items-center justify-center shrink-0">
