...
export default function SavedAddresses() {
  const [addresses, setAddresses] = useState([
    { id: 1, label: "Home",   street: "4521 Oakwood Avenue, Suite 204", city: "Los Angeles, CA 90004",   emoji: "🏠" },
    { id: 2, label: "Office", street: "201 Santa Monica Blvd, Floor 4", city: "Santa Monica, CA 90401", emoji: "🏢" },
  ]);
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-4">
          ...
          <div className="flex flex-col gap-3">
            {["label", "street", "city"].map((field) => (
              <div key={field}>
                <input
                  ...
                  placeholder={
                    field === "label"  ? "Label (e.g. Home, Gym)" :
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => { setShowForm(false); setForm({ label: "", street: "", city: "" }); setErrors({}); }}
        ...
        {addresses.map((addr) => (
          ...
          >
            ...
            <div className="flex-1">
              <p className={`font-bold text-sm mb-0.5 ${selected === addr.id ? "text-[#F4521E]" : "text-[#151515]"}`}>
                {addr.label}
              </p>
